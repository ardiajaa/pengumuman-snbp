...
function alertFeedback() {
  var result = confirm(
    "Beri masukan anda mengenai website ini, saran dan kritik akan diapresiasi (sebenarnya ada error di kodenya cuman ntah dimana mau bantu ga pls)! (wa saja mah)"
  );
  if (result) {
...
function displayInput() {
  ...
  if (ddd == 0) {
    ...
    setTimeout(function () {
      alert(
        "Kalau suka sama webnya, share sama yang lain biar banyak yang tau. IG Author dan Kolom Komentar tertera di menu atas. Jika menunya telah disembunyikan, klik logo SNBP untuk mengembalikannya. SNBP GENERATOR 2024"
      );
    }, 10000);
  }
