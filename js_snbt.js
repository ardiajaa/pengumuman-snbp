...
function alertNote() {
  alert(
    "Web ini adalah SNBT GENERATOR dengan semata-mata untuk tujuan for fun saja. Tidak ada data inputan apapun yang akan dikirim keluar. Harap gunakan dengan bijak! Developer tidak bertanggung jawab atas penyalahgunaan website."
  );
}
...
function displayOutput() {
  ...
  var qrcode = new QRCode(blockQr, {
    text: `Made with SNBT GENERATOR : https://pengumuman-snbp.vercel.app/snbt-generator/ ~${
      document.getElementById("inope").value
    }`,
    width: getWidth() - 30,
    height: getWidth() - 30,
